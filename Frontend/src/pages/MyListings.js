...
export default function MyListings({ sethListingToEdit }) {
  ...
  return (
    <>
      <h1>Created Listings</h1>
      <p>Look At and Manage Your Listings</p>
      <HListingTable hListings={hListings} onDelete={onDelete} onEdit={onEdit}/>
      <br/>
    </>
  )
}